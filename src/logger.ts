    ...
    : {
        ...
        transport: {
          ...
          options: {
            ...
            ignore:
              "pid,hostname,action,price,emaFast,emaSlow,emaTrend,emaFastTrend,emaSlowTrend,momentumPct,atr,atrAvg,cooldownCandlesRemaining,dailyPnlUsdt,dailyTradeCount,entryPrice,unrealizedPnlUsdt,unrealizedPnlPct,reason,orderId,qty,fillPrice,qtyBase,qtyGross,baseCommission,quoteSpent,commissionUsdt,symbol,asset,knownAssets,src,consecutiveFailures",
            singleLine: true,
          },
        },
      }
